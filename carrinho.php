...
<div>
      <a class="carrinho" href="carrinho.php">Seu Carrinho</a>       
...
if(mysqli_num_rows($result)>0){
    while($row = mysqli_fetch_array($result)){
        ...
        <td><a href="carrinho.php?action=delete&name=<?php echo $row["descricao"];?>"><span>remover item</span></a></td> 
        <?php
...
<tr>
    ...
    <td><button style="padding: 8px 16px; background-color: #3498db; color: #ffffff; border: none; border-radius: 4px; cursor: pointer;">
